...
type FootballPlayerProps = {
  ...
  onPlacementChange?: (id: string, isOnField: boolean) => void;
};
...
export default function FootballPlayer({
  ...
  const wasOverTarget = useRef(false);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute top-4 w-4 h-5 rounded-full ${color} flex items-center justify-center text-[11px] font-bold text-white`}
        >
          {number}
        </div>
